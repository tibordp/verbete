<?php
require_once './include/lists.inc.php'; ?><!DOCTYPE html>
<html lang="fr">
    <head>
        <meta charset="utf-8">
        ...
        <meta property="og:url" content="https://verbete.ojdip.net/"/>
                ...
                <div class="col-md-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                La source des conjugasions est le logicel <a href='http://sarrazip.com/dev/verbiste.html'>Verbiste</a>, crée par Pierre Sarazin. Cette application Web a été créée par <a href='https://www.ojdip.net'>Tibor Djurica Potpara</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <table class="table table-condensed verbs_table" >
                            ...
                            foreach (array_slice($verb_list, 0, 8) as $verb) {
                                echo "<tr><td><a href=\"conjugaison.php?verbe=" .
                                    urlencode($verb) .
                                    "\">$verb</a></td></tr>";
                            }
                            ?>
