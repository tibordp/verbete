          ...
          f && window.JSON
            ? {
                ...
                set: function (a, e, g) {
                  return (
                    c.isNumber(g)
                      ? f.setItem(this._ttlKey(a), d(b() + g))
    ...
    g = (function () {
      ...
      return (
        c.mixin(a.prototype, {
          ...
          set: function (a, b) {
            var c;
            this.cachedKeysByAge.length === this.sizeLimit &&
              ((c = this.cachedKeysByAge.shift()), delete this.cache[c]),
              (this.cache[a] = b),
    ...
    h = (function () {
      function b(a) {
        c.bindAll(this),
          ...
          (i = i || new g()),
          (h = c.isNumber(a.maxParallelRequests)
            ? a.maxParallelRequests
            : h || 6),
          (this.url = a.url),
          ...
          (this._get = (/^throttle$/i.test(a.rateLimitFn)
            ? c.throttle
            : c.debounce)(this._get, a.rateLimitWait || 300));
      }
      function d() {
        j++;
      }
          ...
          _sendRequest: function (b) {
            function c() {
              e(),
                (k[b] = null),
                f.onDeckRequestArgs &&
                  (f._get.apply(f, f.onDeckRequestArgs),
                  (f.onDeckRequestArgs = null));
            }
            var f = this,
              g = k[b];
            return (
              g || (d(), (g = k[b] = a.ajax(b, this.ajaxSettings).always(c))), g
            );
          },
          get: function (a, b) {
            var d,
            ...
            return (
              (b = b || c.noop),
              (d = this.replace
                ? this.replace(this.url, g)
                : this.url.replace(this.wildcard, g)),
              (e = i.get(d))
                ? c.defer(function () {
      ...
      return (
        c.mixin(d.prototype, {
          ...
          _loadPrefetchData: function (d) {
            function e(a) {
              var b = d.filter ? d.filter(a) : a,
                ...
                h = e.adjacencyList;
              m.storage &&
                (m.storage.set(g.itemHash, f, d.ttl),
                m.storage.set(g.adjacencyList, h, d.ttl),
                m.storage.set(g.thumbprint, n, d.ttl),
                m.storage.set(g.protocol, c.getProtocol(), d.ttl)),
            ...
            return (
              this.storage &&
                ((f = this.storage.get(g.thumbprint)),
                (h = this.storage.get(g.protocol)),
                (i = this.storage.get(g.itemHash)),
                (j = this.storage.get(g.adjacencyList))),
              (k = f !== n || h !== c.getProtocol()),
              (d = c.isString(d) ? { url: d } : d),
              (d.ttl = c.isNumber(d.ttl) ? d.ttl : 864e5),
              i && j && !k
                ? (this._mergeProcessedData({ itemHash: i, adjacencyList: j }),
                  (l = a.Deferred().resolve()))
                : (l = a.getJSON(d.url).done(e)),
              l
            );
          },
          _transformDatum: function (a) {
            ...
            return (
              c.isString(a)
                ? ((e.datum = {}), (e.datum[this.valueKey] = a))
                : (e.datum = a),
          ...
          _getLocalSuggestions: function (a) {
            ...
            return (
              ...
              c.each(e, function (a, c) {
                ...
                return e
                  ? (f.push(e), (!b || e.length < b.length) && (b = e), void 0)
                  : !1;
              }),
              f.length < e.length
                ? []
        ...
        c.bindAll(this),
          ...
          c.isMsie()
            ? this.$input.on(
                ...
                function (a) {
                  d.specialKeyCodeMap[a.which || a.keyCode] ||
        ...
        c.mixin(b.prototype, d, {
          ...
          _compareQueryToInputValue: function () {
            ...
            c
              ...
              : b || this.trigger("queryChanged", { value: (this.query = a) });
          },
          destroy: function () {
            this.$hint.off(".tt"),
              this.$input.off(".tt"),
        ...
        c.mixin(b.prototype, d, {
          ...
          _moveCursor: function (a) {
            ...
            if (this.isVisible()) {
              ...
              -1 > d && (d = b.length - 1),
                (f = b.eq(d).addClass("tt-is-under-cursor")),
                this._ensureVisibility(f),
          ...
          renderSuggestions: function (b, d) {
            var e,
              ...
              n = this.$menu.find("." + l);
            0 === n.length &&
              ((h = a(f.suggestionsList).css(g.suggestionsList)),
              (n = a("<div></div>")
                .addClass(l)
                .append(b.header)
                .append(h)
          ...
          clearSuggestions: function (a) {
            var b = a
                ? this.$menu.find(".tt-dataset-" + a)
                : this.$menu.find('[class^="tt-dataset-"]'),
              c = b.find(".tt-suggestions");
            b.hide(),
              c.empty(),
              0 === this._getSuggestions().length &&
                ((this.isEmpty = !0), this._hide());
          },
        }),
        b
      );
    ...
    l = (function () {
      ...
      var g = {
        ...
        h = {
          ...
          query: { position: "relative", verticalAlign: "top" },
          dropdown: {
            position: "absolute",
            top: "100%",
            left: "0",
      ...
      return (
        ...
        c.isMsie() &&
          c.isMsie() <= 7 &&
          (c.mixin(h.wrapper, { display: "inline", zoom: "1" }),
          c.mixin(h.query, { marginTop: "-1px" })),
        c.mixin(b.prototype, d, {
          _managePreventDefault: function (a) {
            ...
            switch (a.type) {
              case "tabKeyed":
                (b = this.inputView.getHintValue()),
                  (c = this.inputView.getInputValue()),
                  (e = b && b !== c);
                break;
              case "upKeyed":
              case "downKeyed":
          ...
          _closeDropdown: function (a) {
            this.dropdownView[
              "blured" === a.type ? "closeUnlessMouseIsOverDropdown" : "close"
            ]();
          },
          _moveDropdownCursor: function (a) {
            ...
            b.shiftKey ||
              ...
              b.metaKey ||
              this.dropdownView[
                "upKeyed" === a.type ? "moveCursorUp" : "moveCursorDown"
              ]();
          },
          _handleSelection: function (a) {
            ...
            d &&
              ...
              b && c.isMsie()
                ? c.defer(this.dropdownView.close)
          ...
          _autocomplete: function (a) {
            ...
            (("rightKeyed" !== a.type && "leftKeyed" !== a.type) ||
              ...
              (c =
                "ltr" === this.inputView.getLanguageDirection()
                  ? "leftKeyed" === a.type
                  : "rightKeyed" === a.type),
              b && !c)) &&
  ...
  !(function () {
    ...
    (b = {
      initialize: function (b) {
        function g() {
          ...
          (b = c.map(h, function (a) {
            ...
            d.data(
              f,
              new l({ input: d, eventBus: (g = new e({ el: d })), datasets: h })
            ),
      ...
      (jQuery.fn.typeahead = function (a) {
        return b[a]
          ? b[a].apply(this, [].slice.call(arguments, 1))
